...
const requireEmployee       = requireRole(ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.SUB_ADMIN, ROLES.EMPLOYEE, ROLES.RECEPTIONIST);
const requireReceptionist   = requireRole(ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.SUB_ADMIN, ROLES.RECEPTIONIST);
const requireSecurity       = requireRole(ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.SUB_ADMIN, ROLES.EMPLOYEE, ROLES.RECEPTIONIST, ROLES.CLIENT);

module.exports = {
  requireRole, requirePlatformAdmin, requireOrgSuperAdmin, requireOrgAdmin,
  requireAdmin, requireEmployee, requireReceptionist, requireSecurity,
